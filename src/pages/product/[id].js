...
import { cartItemsState } from '../../services/CartContext.js';
          ...
          <div className="flex flex-col justify-center">
            {product && (
              <>
                ...
                <p className="text-3xl bg-white p-3 rounded-lg text-blue-400 font-bold mb-4 max-w-max ">
                  ${product.price}
                </p>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  <label
                    htmlFor="amount"
                    className="bg-white text-lg text-blue-400 font-semibold mb-2 mr-1 p-3 rounded-tl-lg rounded-bl-lg"
                  >
                    Amount:
                  </label>
                  <input
